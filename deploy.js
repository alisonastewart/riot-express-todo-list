...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf riot-express-todo-list-master-temp && mkdir riot-express-todo-list-master-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r riot-express-todo-list-master-temp/* riot-express-todo-list-master/ && rm -rf riot-express-todo-list-master-temp', {
      cwd: '/home/ubuntu'
  });
}
